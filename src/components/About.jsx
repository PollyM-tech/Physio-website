  ...
  return (
    <div className="relative overflow-hidden font-sans">
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-[1240px] mx-auto flex flex-col md:flex-row items-start gap-12">
          ...
          <div className="flex-1 flex flex-col justify-center gap-4 animate-fadeInUp">
            ...
            <p className="text-base md:text-lg leading-relaxed mb-4">
              My goal is to provide personalized care that not only treats symptoms but addresses the root cause of pain and dysfunction—ensuring long-term recovery, improved mobility, and well-being.
            </p>
      ...
      <section className="py-24 px-6">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all bg-[#FBBF24]/10 cursor-pointer">
            ...
            <h3 className="text-2xl font-bold text-[#FBBF24] mb-2">Pain Management</h3>
            <p className="text-gray-700">Evidence-based techniques to relieve pain and restore comfort quickly.</p>
          </div>
          <div className="p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all bg-[#06B6D4]/10 cursor-pointer">
            ...
            <h3 className="text-2xl font-bold text-[#06B6D4] mb-2">Rehabilitation Therapy</h3>
            <p className="text-gray-700">Customized rehab programs to regain strength and mobility after injury.</p>
          </div>
          <div className="p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all bg-[#2EA3DD]/10 cursor-pointer">
            ...
            <p className="text-gray-700">Specialized therapy for athletes and active individuals to recover fast.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-[#eef2f6] via-white to-[#f8fafc]">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="p-8 rounded-2xl shadow-lg bg-white hover:shadow-2xl transition-all">
            <p className="text-gray-700 mb-4">"Dr. Okinda helped me recover from my knee injury faster than I imagined. Highly recommended!"</p>
            <h4 className="font-bold text-[#041E2A]">Jane Doe</h4>
            <p className="text-gray-500 text-sm">Patient</p>
          </div>
          <div className="p-8 rounded-2xl shadow-lg bg-white hover:shadow-2xl transition-all">
            <p className="text-gray-700 mb-4">"Professional, caring, and effective physiotherapy. I feel stronger and healthier."</p>
            <h4 className="font-bold text-[#041E2A]">John Smith</h4>
            <p className="text-gray-500 text-sm">Patient</p>
          </div>
          <div className="p-8 rounded-2xl shadow-lg bg-white hover:shadow-2xl transition-all">
            <p className="text-gray-700 mb-4">"The best physiotherapist I’ve visited. Personalized care and amazing results."</p>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <a href="/contact" className="inline-block px-10 py-4 rounded-full bg-[#2EA3DD] text-white font-semibold hover:bg-[#0f5e93] transition-colors">
          Contact Me
        </a>
      </section>
