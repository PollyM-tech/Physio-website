...
const AboutPage = () => {
  ...
  return (
    <div className="relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-40 sm:w-60 h-40 sm:h-60 bg-[#2EA3DD]/20 rounded-full blur-3xl animate-floatSlow -z-10"></div>
      <div className="absolute bottom-10 right-0 w-60 sm:w-72 h-60 sm:h-72 bg-[#FBBF24]/20 rounded-full blur-3xl animate-floatSlow2 -z-10"></div>
      <div className="absolute top-1/2 right-10 sm:right-20 w-32 sm:w-48 h-32 sm:h-48 bg-[#06B6D4]/20 rounded-full blur-3xl animate-floatSlow3 -z-10"></div>

      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#f0f4f8] via-[#e0f7fa] to-[#fff7ed] py-20 sm:py-24 px-6 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#2EA3DD] mb-4">
          Dr. David Okinda
        </h1>
      ...
      <section className="py-20 sm:py-24 px-6">
        <div className="max-w-[1240px] mx-auto flex flex-col md:flex-row items-start gap-8 sm:gap-12">
          {/* Left Panel */}
          <div className="flex-1 bg-white/80 backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-2xl flex flex-col items-center gap-6 animate-fadeIn">
            <img
              src={profilePic}
              alt="Dr. David Okinda"
              className="rounded-2xl object-cover shadow-2xl w-full max-w-[400px] sm:max-w-[450px] h-auto animate-float"
            />
          ...
          {/* Right Panel */}
          <div className="flex-1 flex flex-col justify-center gap-4 animate-fadeInUp text-center md:text-left">
            <p className="text-xs tracking-[0.2em] text-[#062B3D] mb-2">
      ...
      <section className="py-20 sm:py-24 px-6 text-center">
        ...
        <a
          href="/contact"
          className="inline-block px-8 sm:px-10 py-3 sm:py-4 rounded-full bg-[#2EA3DD] text-white font-semibold hover:bg-[#0f5e93] transition-colors"
        >
          Contact Me
        </a>
      </section>
